...
💡 I love exploring **computer science concepts**, solving problems, and applying them to **real-life applications**.
...
- **Frameworks & Tools:** AutoCAD, Git/GitHub, MySQL  
...
- 🐍 [SakibPy](https://github.com/Sakibcheez/SakibPy) – Python code snippets & Jupyter notebooks  
- 🛠️ [MY_SQL](https://github.com/Sakibcheez/MY_SQL) – SQL practice & database design  

---

### 🌐 Web & Software Projects
- 🤖 **AI Projects**
  - [AI-based-Real-Time-Public-Transport-Monitoring--System-for-Dhaka](https://github.com/Sakibcheez/AI-based-Real-Time-Public-Transport-Monitoring--System-for-Dhaka) – AI-based transport monitoring system for Dhaka  
  - *AI Website Assistant* *(Private)* – AI-powered assistant for PC component buy/sell  

- 🩸 [Blood-Donation---Inventory-Management-System](https://github.com/Sakibcheez/Blood-Donation---Inventory-Management-System) – PHP & MySQL-based system  
- 🍔 *Khaboi Khabo Website* *(Private)* – Food ordering website using PHP, JS, MySQL  
- ☕ [Kashundi-Cafe-Management-System-Java](https://github.com/Sakibcheez/Kashundi-Cafe-Management-System-Java) – Java-based café management system  
...
- 🚏 [BUS-FAIR-CALCULATOR-CPLUSPLUS](https://github.com/Sakibcheez/BUS-FAIR-CALCULATOR-CPLUSPLUS) – Bus fare calculation project in C++  
- ☕ [MyJavaCode](https://github.com/Sakibcheez/MyJavaCode) – Java practice repository  
- ☕ [JavaCode1](https://github.com/Sakibcheez/JavaCode1) – Additional Java exercises  
- 🌐 [Java_Networking](https://github.com/Sakibcheez/Java_Networking) – Networking concepts implemented in Java  
- 🖥️ [AutoCAD](https://github.com/Sakibcheez/AutoCAD) – AutoCAD drawings & projects  

---

### 📦 Miscellaneous
- ⚙️ [Sakibcheez](https://github.com/Sakibcheez/Sakibcheez) – GitHub profile configuration repository  
...
- 📷 Instagram: https://www.instagram.com/sakib_beez  
